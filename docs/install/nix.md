...
[`scripts/package-mac-app.sh`](https://github.com/opensoul/opensoul/blob/main/scripts/package-mac-app.sh) copies this template into the app bundle and patches dynamic fields
