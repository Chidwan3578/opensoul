...
export function connectGateway(host: GatewayHost) {
  ...
  host.client = new GatewayBrowserClient({
    ...
    clientName: "opensoul-control-ui",
    mode: "webchat",
    onHello: (hello) => {
      host.connected = true;
      host.lastError = null;
      host.hello = hello;
      // Notify desktop shell about connection state
      sendConnectionStateChanged("connected");
      ...
      void loadAssistantIdentity(host as unknown as OpenSoulApp);
      void loadAgents(host as unknown as OpenSoulApp);
      void loadNodes(host as unknown as OpenSoulApp, { quiet: true });
